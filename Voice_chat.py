...
def main():
    ...
    # system prompt 설정, gpt-3.5-turbo  영문과 한글 2배 차이라 영문으로 표시, 배경지식을 여기에 집어 넣는다. 
    ...
    if "messages" not in st.session_state: # prompt 저장 
    ...
    with st.sidebar:
        ...
        # GPT 모델을 선택하기 위한 라디오 버튼, gpt-3.5-turbo  영문과 한글 2배 차이라 영문으로 표시 
